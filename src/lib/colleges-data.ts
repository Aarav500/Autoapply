...
export const targetColleges: CollegeInfo[] = [
    {
        ...
        essays: [
            ...
            {
                id: 'mit-6',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For MIT: Emphasize how you problem-solved through adversity, showed intellectual curiosity despite obstacles, and demonstrated hands-on resilience ("Mens et Manus").',
                wordLimit: 1250,
                required: false,
            },
            {
                ...
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For MIT: Highlight collaborative projects, unexpected innovations, or unique maker/hacker experiences that demonstrate your "productive weirdness" and passion-driven work.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'stanford-5',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For Stanford: Emphasize how you demonstrated entrepreneurial resilience, maintained intellectual vitality despite obstacles, took calculated risks, and showed the innovative thinking that defines Stanford\'s "wind of freedom."',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'stanford-6',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For Stanford: Highlight entrepreneurial ventures, interdisciplinary projects, or unique experiences that demonstrate your intellectual vitality, willingness to take risks, and ability to think differently in pursuit of meaningful impact.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'cmu-4',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For Carnegie Mellon: Focus on technical creativity, resilience through hard work ("My heart is in the work"), how you bridged disciplines or found innovative solutions, and the Scottish heritage of toughness and perseverance.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'cmu-5',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For Carnegie Mellon: Highlight cross-disciplinary projects, creative technical work, collaborations that bridge art and technology, or unique experiences that demonstrate your passion and commitment to excellence.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'nyu-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For NYU: Highlight your global perspective, NYC-style resilience and adaptability, how diverse experiences shaped your response, and your independent spirit in navigating challenges.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'nyu-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For NYU: Emphasize global experiences, urban adaptability, diverse perspectives you bring, or unique ways you\'ve engaged with New York City\'s energy and opportunities.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'cornell-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For Cornell: Emphasize how "Any Person Any Study" resonates with your diverse interests, your Ivy League commitment to excellence, and how you persevered through challenges while maintaining intellectual curiosity.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'cornell-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For Cornell: Highlight diverse academic interests, community contributions, unique perspectives you bring, or experiences that demonstrate your alignment with Cornell\'s "any person, any study" philosophy.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'uwash-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For University of Washington: Focus on commitment to the public good, community impact, Pacific Northwest values of sustainability and innovation, and how you persevered with the spirit of "Lux sit."',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'uwash-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For University of Washington: Highlight community service, environmental initiatives, innovative projects, or experiences that demonstrate your commitment to public good and Pacific Northwest values.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'uiuc-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For UIUC: Highlight engineering excellence mindset, "Learning and Labor" work ethic, heartland values of determination and perseverance, and how you maintained technical rigor despite obstacles.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'uiuc-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For UIUC: Emphasize technical projects, research initiatives, work ethic, or unique experiences that demonstrate your engineering passion and commitment to excellence.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'gatech-2',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For Georgia Tech: Emphasize "Progress and Service" mindset, STEM excellence and innovation, how you problem-solved through adversity, and your commitment to making an impact.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'gatech-3',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For Georgia Tech: Highlight technical innovations, service projects, leadership in STEM, or unique experiences that demonstrate your commitment to progress and your potential to create positive change.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'usc-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For USC: Focus on Trojan Family resilience, leadership through adversity, Fight On! spirit, and how you leveraged Los Angeles opportunities or community support to persevere.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'usc-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For USC: Highlight leadership roles, Trojan Family connections, creative or entrepreneurial ventures, or unique experiences that demonstrate your fit with USC\'s values and collaborative spirit.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'ut-4',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For UT Austin: Highlight Texas pride and Hook \'em Horns spirit, community leadership, resilience, and how you embodied the Longhorn values of excellence and determination.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'ut-5',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For UT Austin: Emphasize community leadership, Texas connections, unique perspectives from diverse experiences, or achievements that demonstrate your alignment with Longhorn values and Austin\'s innovative spirit.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'neu-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For Northeastern: Emphasize experiential learning mindset, co-op resilience and adaptability, practical problem-solving, and how real-world challenges prepared you for success.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'neu-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For Northeastern: Highlight work experience, internships, global experiences, practical projects, or initiatives that demonstrate your career-focused mindset and experiential learning approach.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'nus-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For NUS: Focus on Asian excellence standards, global outlook and adaptability, efficiency and resilience, and how you maintained academic rigor while navigating challenges.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'nus-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For NUS: Highlight global perspective, leadership in diverse contexts, research or innovation projects, or experiences that demonstrate your readiness for NUS\'s rigorous and internationally-focused environment.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            {
                id: 'umich-2',
                title: 'Personal Statement - Overcoming Obstacles',
                prompt: 'The lessons we take from obstacles we encounter can be fundamental to later success. Recount a time when you faced a challenge, setback, or failure. How did it affect you, and what did you learn from the experience? (Common App Essay - Choose the option that best helps you answer the question: What do you want admissions readers to know about you that is not reflected elsewhere in your application?)',
                wordLimit: 650,
                required: true,
            },
            {
            ...
            },
            {
                id: 'umich-5',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For UMich: Focus on resilience, growth, and how you overcame these challenges while demonstrating the "Leaders and Best" mindset.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'umich-6',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For UMich: Consider highlighting unique experiences, leadership roles, or community contributions that align with Michigan\'s values of excellence and public good.',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'purdue-3',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For Purdue: Highlight Giant Leaps mindset, engineering rigor and determination, Boilermaker perseverance, and how you maintained technical excellence despite obstacles.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'purdue-4',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For Purdue: Emphasize engineering projects, research initiatives, technical achievements, or unique experiences that demonstrate your Boilermaker work ethic and commitment to making "giant leaps."',
                wordLimit: 1500,
                required: false,
            },
        ],
    ...
    },
    {
        ...
        essays: [
            ...
            },
            {
                id: 'umd-2',
                title: 'Academic Challenges - Grade Explanation',
                prompt: 'Please describe the challenges or circumstances that impacted your academic performance (particularly in Grade 12), and how they have affected you. For UMD: Emphasize fearless ideas, research excellence, Mid-Atlantic values of determination and resilience, and how you pursued innovation despite obstacles.',
                wordLimit: 1250,
                required: false,
            },
            {
                id: 'umd-3',
                title: 'Additional Information',
                prompt: 'Would you like to share any additional details or qualifications not reflected in the application? For UMD: Highlight research projects, leadership roles, fearless ideas you\'ve pursued, or experiences that demonstrate your alignment with Maryland\'s values and DC-area opportunities.',
                wordLimit: 1500,
                required: false,
            },
        ],
